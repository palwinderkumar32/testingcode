...
public final class forgot_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t<h4>Recover Password</h4>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div id=\"log\">\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<form id=\"form1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<fieldset>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tEnter Your Email:<input id=\"text1\" type=\"text\" name=\"email\" /><br/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"button\" id=\"login-submit\" onclick=\"sendInfo()\" value=\"ok\"/><br/><br/>\r\n");
